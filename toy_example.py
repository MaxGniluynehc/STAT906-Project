...
def toy_sampler(n, T=100, p0=1):
    """
    generate V-shaped toy samples based on the paper
    :param n: total number of samples
    :param T: time steps of each sample
    :param p0: initial value of pnl
    :return:
    """
    pt = tc.ones([n, T+1]) * p0
    ...
    for epoch in epochs:
        for idx, ps_real in enumerate(dataloader, 0):
            ...
            for _ in range(3):  # (idx<=10 and epoch ==0):
                ...
                # generate fake data by standard normal distribution
        ...
        if (epoch + 1) % 10 == 0:
            ...
            # plot fake data generated by the trained generator
